...
const config: Config = {
  ...
  // Single mode (Issuer) — no darkMode switching.
  theme: {
    extend: {
      ...
      backgroundColor: {
        ...
        quarternary: "var(--colors-bg-quarternary)",
        ...
        "brand-quarternary": "var(--colors-bg-brand-quarternary)",
        ...
        "brand-subtle-quarternary": "var(--colors-bg-brand-subtle-quarternary)",
        ...
        // Semantic alpha layers (override bg-alpha-* to use semantic vars
        // from the Issuer mode instead of primitive ones — values may diverge
        // in the future).
      ...
      borderColor: {
        ...
        quarternary: "var(--colors-border-quarternary)",
      ...
      spacing: {
        ...
        // Icon sizes (for width/height utilities)
      ...
      // No shadow tokens in this project.
    },
  },
  plugins: [],
};
